...
aspect of the RSP running at either the summit or the data facility.
Â~An appropriate weekly version of the stack will be chosen.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
\includegraphics[width=9.14583in]{jira_imgs/1842.png}The attached plot
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
\includegraphics[width=9.14583in]{jira_imgs/1844.png}As expected, the
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
\includegraphics[width=7.75000in]{jira_imgs/1851.png}As with other plots
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The histogram does indeed show that all elements end up in the bin
containing the value 1. ~Even more convincing is that when asking if all
the elements in the pairwise difference array are 1, the answer is
``yes'' (see cell 6).\\[3\baselineskip]
